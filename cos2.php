...
$list = fgets($fp);  
  ...
  fclose($fp);
	...
	$ready=$_GET["ready"];
	if(!empty($ready)){
		echo "window.location.href='cos2.php?akx='+". $pakax ."+'&aky='+". $pakay ."+'&rx='+rx+'&ry='+ry+'&ready=1';";
...
kolej=data.split("a");
	// console.log(kolej[0]);	
	 if(kolej[0]==2){
window.location.href='cos2.php?akx='+kolej[1]+'&aky='+kolej[2]+'&ready=1';
...
$list = fgets($fp);  
  ...
  fclose($fp);
	...
	if ($clickx==$bx and $clicky==$by and $lastx==$ax and $lasty==$ay){
		...
		header("Location: cos2.php?akx=".$pakax."&aky=".$pakay."&ready=1");
...
fclose($fp);
  ...
  echo "<script>window.location.href='cos2.php?akx=".$clickx."&aky=".$clicky."&ready=1';</script>";
...
echo "<script>window.location.href='cos2.php?akx=".$clickx."&aky=".$clicky."';</script>";
